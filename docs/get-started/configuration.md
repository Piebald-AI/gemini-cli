...
- **`general.sessionRetention.maxAge`** (string):
  - **Description:** Maximum age of sessions before deletion (e.g., "1h", "7d",
    "30d"). Minimum: "1h".
  - **Default:** `undefined`

- **`general.sessionRetention.maxCount`** (number):
  - **Description:** Maximum number of sessions to keep. When exceeded, oldest
    sessions are deleted first. Minimum: 1.
  - **Default:** `undefined`
